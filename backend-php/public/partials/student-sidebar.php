...
<div class="lg:hidden fixed top-16 left-0 right-0 z-40 h-12 bg-surface-white dark:bg-dm-surface border-b border-outline-variant dark:border-dm-border shadow-sm flex items-center justify-between px-4">
  <p class="text-xs uppercase tracking-widest text-outline dark:text-dm-text-secondary font-bold">พอร์ทัลนักศึกษา</p>
  <button type="button" id="student-mobile-menu-btn" aria-label="เปิดเมนู" class="w-9 h-9 flex items-center justify-center rounded-lg text-on-surface-variant dark:text-dm-text-secondary hover:bg-surface-container-high dark:hover:bg-dm-bg">

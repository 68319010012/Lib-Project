...
// ต้องตรงกับข้อความใน public/dashboard.php — ตัวนั้นคือค่าที่เห็นตอนโหลดหน้า
// ตัวนี้คือค่าที่เขียนทับเวลาสถานะเปลี่ยน ชื่อห้องสมุดมาจาก LIBRARY_NAME
const STAMP_HINT_OPEN = 'กดปุ่มด้านบนเพื่อบันทึกการเข้า-ออกห้องสมุดพระครูสุขุมสมาจารย์';

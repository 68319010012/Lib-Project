...
// ชื่อห้องสมุดตามป้ายจริงหน้าห้อง — "ห้องสมุดพระครูสุขุมสมาจารย์" เป็นชื่อที่
// ตั้งตามผู้ก่อตั้ง ไม่ใช่คำเรียกทั่วไปว่า "ห้องสมุด" เฉย ๆ เอกสารที่ส่งออกจาก
// ระบบต้องใช้ชื่อนี้ ไม่งั้นระบุไม่ได้ว่าเป็นห้องสมุดของที่ไหน
//
// สามรูปแบบ เพราะที่ว่างแต่ละจุดไม่เท่ากัน:
//   LIBRARY_NAME_FULL  หัวรายงาน หน้าเข้าสู่ระบบ แบนเนอร์ — ที่ที่ต้องเป็นทางการ
//   LIBRARY_NAME       ชื่อห้องสมุดล้วน ๆ ไม่พ่วงชื่อวิทยาลัย
//   LIBRARY_NAME_SHORT แถบหัวบนมือถือ ชื่อใต้ไอคอนแอป แท็บเบราว์เซอร์ — จุดที่
//                      ชื่อเต็มจะล้นขอบหรือถูกตัดกลางคำ
// public/manifest.webmanifest กับ public/offline.html เป็นไฟล์สแตติก PHP ไม่ได้
// ประมวลผล จึงเขียนชื่อไว้ตรง ๆ — แก้ที่นี่แล้วอย่าลืมสองไฟล์นั้นด้วย
const COLLEGE_NAME = 'วิทยาลัยเทคนิคนครนายก';
const LIBRARY_NAME = 'ห้องสมุดพระครูสุขุมสมาจารย์';
const LIBRARY_NAME_FULL = LIBRARY_NAME . ' ' . COLLEGE_NAME;
const LIBRARY_NAME_SHORT = 'ห้องสมุดพระครูฯ';
